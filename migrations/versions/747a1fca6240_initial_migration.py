...
Revision ID: 747a1fca6240
Revises: 
Create Date: 2022-02-09 12:35:59.070771
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('aprover', 'complainer', 'admin', name='roletype'), server_default='complainer', nullable=False),
